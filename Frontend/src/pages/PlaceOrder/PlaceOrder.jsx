...
const PlaceOrder = () => {
  const { getTotalCartAmount, Token, JewellryData, cartItems, url } = useContext(StoreContext);
              ...
              <div className='payment'>
                {paymentMethod === "online" ? (<><img src={assets.QR_code} alt="" />
                  <div className="payupi">
                    <b>Or</b>
                    <div className='phonepay'><img src={assets.Phone_pay} alt="" /><p>8857804794@ybl</p><img src={assets.Copy} onClick={() => copyText("8857804794@ybl")} className='Copy' alt="" /></div>

                    <div className='Googlepay'><img src={assets.Googlepay} alt="" /><p>8857804794@ybl</p><img src={assets.Copy} onClick={() => copyText("8857804794@ybl")} className='Copy' alt="" /></div>
                  </div></>) : (<></>)}
